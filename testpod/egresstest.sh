...
echo " ">> /tmp/test_output.txt
kubectl annotate pod $1 kubernetes.io/egress-chaos="{\"Reorder\":{\"Set\":\"yes\",\"Time\":\"1100ms\",\"Percengtage\":\"50%\",\"Relate\":\"25%\"},\"Rate\":\"100kbps\"}" kubernetes.io/done-egress-chaos=no --overwrite
sleep 2
ping $2 -c 20 -i 0.01 >>/tmp/test_output.txt
